...
namespace iTaxSuite.CLIApp
{
    public class iTaxDriver
    {
        ...
        private readonly S300DTaxSaleService _dTaxSaleService;
        ...
        public iTaxDriver(IDataProtectionProvider dataProtectionProvider, ETimsDBContext dBContext = null,
            S300DTaxSaleService dTaxSaleService = null, IMasterDataSvc masterDataSvc = null)
        {
            _dataProtector = dataProtectionProvider.CreateProtector(SecureConst.DATA_PURPOSE);
            _dBContext = dBContext;
            _dTaxSaleService = dTaxSaleService;
        ...
        private async Task SelectFilterInvoices()
        {
            ...
            #endregion
            var result = await _dTaxSaleService.SelectFilterInvoices(jsonDump);
            if (result.IsSuccess)
            {

...
namespace iTaxSuite.Library.Migrations
{
    ...
    [Migration("20260220051533_salesItem_pkswap_ItemCOde-SourceLineNo")]
    partial class salesItem_pkswap_ItemCOdeSourceLineNo
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("iTaxSuite.Library.Models.Entities.SalesItem", b =>
                {
                    ...
                    b.HasKey("SalesTrxID", "SourceLineNo", "BranchCode");
            ...
            modelBuilder.Entity("iTaxSuite.Library.Models.Entities.SalesItem", b =>
                {
                    b.HasOne("iTaxSuite.Library.Models.Entities.SalesTransact", "SalesTransact")
                        .WithMany("SalesItems")
                        .HasForeignKey("SalesTrxID", "BranchCode")
                        .HasPrincipalKey("SalesTrxID", "BranchCode")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

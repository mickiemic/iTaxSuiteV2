...
namespace iTaxSuite.Library.Interfaces
{
    public interface IS300SaleService
    {
        ...
        Task<Result<EtimsSalesView, string>> GetConvertARCRNote(SaleBatchTrxKey saleBatchTrxKey, string srcPayload = null);
        Task<Result<EtimsSalesView, string>> GetConvertARInvoice(SaleBatchTrxKey saleBatchTrxKey, string srcPayload = null);
        Task<Result<EtimsSalesView, string>> GetConvertOECRNote(SaleTrxKey saleTrxKey, string srcPayload = null);
        ...
        Task<Result<SalesTransact, string>> ReFetchInvoice(SaleBatchTrxKey saleTrxKey);
